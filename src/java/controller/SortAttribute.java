 ...
 * @author Vuh26
 */
public class SortAttribute extends HttpServlet {
    ...
    request.setAttribute("list", courses); // quan trọng: khớp với c:forEach trong JSP
    request.setAttribute("totalPages", totalPages);
    request.setAttribute("pageNumber", page); // khớp với JSP
    request.setAttribute("searchName", searchName);
    request.setAttribute("sortName", sortColumn); // khớp với JSP
