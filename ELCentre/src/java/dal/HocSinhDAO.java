...
public class HocSinhDAO {
    ...
    public boolean addStudentToClass(int idHocSinh, int idLopHoc) {
        ...
        String checkHocSinhSql = """
                             SELECT COUNT(*) FROM HocSinh WHERE ID_HocSinh = ?
                             """;
        String checkLopHocSql = """
                            SELECT COUNT(*) FROM LopHoc WHERE ID_LopHoc = ?
                            """;
        String checkExistSql = """
                           SELECT COUNT(*) FROM HocSinh_LopHoc 
                           WHERE ID_LopHoc = ? AND ID_HocSinh = ?
                           """;
        String insertSql = """
                       INSERT INTO HocSinh_LopHoc (ID_LopHoc, ID_HocSinh)
                       VALUES (?, ?)
                       """;
