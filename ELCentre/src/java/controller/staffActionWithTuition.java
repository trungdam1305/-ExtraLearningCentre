 ...
 * @author wrx_Chur04
 */
public class staffActionWithTuition extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet staffActionWithTuition</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet staffActionWithTuition at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doFilterHocPhi(HttpServletRequest request, HttpServletResponse response)
        ...
        if (hocphis != null) {
            ...
            request.getRequestDispatcher("/views/staff/staffViewHocPhiTheoLopHoc.jsp").forward(request, response);
        } else {
    ...
    protected void dofilterClass(HttpServletRequest request, HttpServletResponse response)
        ...
        if (keyword.equals("") && khoi.equals("") && mon.equals("") && trangthai.equals("")) {
            ...
            if (lophocs1.isEmpty()) {
                ...
                request.getRequestDispatcher("/views/staff/staffReceiveHocPhi.jsp").forward(request, response);
            } else {
    ...
    protected void doSendThongBao(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/views/staff/staffSendTBAOHocPhiChoPHHS.jsp").forward(request, response);
