...
public class ManagerCourse extends HttpServlet {
    ...
    if ("deleteCourse".equals(action)) {
        try {
            ...
            if ("chưa bắt đầu".equalsIgnoreCase(trangThai) || "kết thúc".equalsIgnoreCase(trangThai)) {
        ...
        request.getRequestDispatcher("/views/viewCour.jsp").forward(request, response);
        ...
        try {
            ...
            if ("chưa bắt đầu".equalsIgnoreCase(trangThai) || "kết thúc".equalsIgnoreCase(trangThai)) {
                ...
                request.setAttribute("khoaHoc", khoaHoc);
                request.getRequestDispatcher("/views/update_course.jsp").forward(request, response);
            } else {
