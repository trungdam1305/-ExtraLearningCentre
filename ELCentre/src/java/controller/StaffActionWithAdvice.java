...
public class StaffActionWithAdvice extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("staffAprovedRegistration.jsp");
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("update".equals(action)) {
            ...
            if (tb != null) {
                ...
                response.sendRedirect("StaffGetFromDashboard?action=yeucautuvan");
            }
        }
    }
