...
protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
        // Ép trạng thái luôn là "chưa bắt đầu"
      String   trangThai = "chưa bắt đầu";

        // Kiểm tra tên bị trùng
        if (KhoaHocDAO.isTenKhoaHocDuplicate(ten)) {
        ...
        // Kiểm tra ngày kết thúc sau ngày bắt đầu ít nhất 30 ngày
        ...
        KhoaHoc khoaHoc = new KhoaHoc(null, ten, moTa, batDau, ketThuc, ghiChu, trangThai, LocalDateTime.now());
        ...
        if (result != null) {
            ...
            request.setAttribute("err", "Thêm khóa học thất bại!");
        }
