 ...
 * @author Vuh26
 */
public class Course_ManagerCourse extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("deleteCourse".equals(action)) {
            ...
            try {
                ...
                int pageSize = 6; // Đồng bộ số mục mỗi trang
                int pageNumber = 1; // Mặc định trang 1
                try {
                    ...
                    pageNumber = 1; // Fallback nếu page không hợp lệ
                }
                ...
                int totalPages = (int) Math.ceil((double) totalItems / pageSize); // Đồng bộ pageSize
                ...
                Logger.getLogger(Course_ManagerCourse.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String[] args) throws SQLException {
        LopHocDAO lhd = new LopHocDAO();
        List<LopHoc> danhSachLopHoc = lhd.getLopHocByKhoaHocAndKhoi(1, 1);
        System.out.println(danhSachLopHoc.toString());
    }
}
