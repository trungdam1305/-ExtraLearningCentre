...
/**
 * Servlet to manage class details, including assigning teachers, adding/removing students, and sending notifications for Staff.
 *
 * @author Vuh26
 */
public class Staff_ManageClassDetail extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            HttpSession session = request.getSession();
            session.setAttribute("err", "Tham số không hợp lệ!");
            response.sendRedirect("Staff_ManageClassDetail?ID_LopHoc=" + request.getParameter("ID_LopHoc") + "&ID_KhoaHoc=" + request.getParameter("ID_KhoaHoc") + "&ID_Khoi=" + request.getParameter("ID_Khoi"));
            return;
        }
    ...
    public String getServletInfo() {
        return "Servlet to manage class details, including assigning teachers, adding/removing students, and sending notifications for Staff";
    }
}