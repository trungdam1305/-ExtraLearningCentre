...
/**
 * Servlet to manage class listing, adding, updating, and deleting for Staff.
 *
 * @author Vuh26
 */
@MultipartConfig(
...
public class Staff_ManageClass extends HttpServlet {
    ...
    public String getServletInfo() {
        return "Servlet to manage class listing, adding, updating, and deleting for Staff";
    }
}