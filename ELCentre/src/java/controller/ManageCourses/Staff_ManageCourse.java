...
/**
 * Servlet to manage course listing, sorting, pagination, and actions for Staff.
 *
 * @author Vuh26
 */
@MultipartConfig(
...
public class Staff_ManageCourse extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Staff_ManageCourse</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Staff_ManageCourse at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            pageNumber = 1;
            System.out.println("Staff_ManageCourse: Invalid page parameter - page=" + pageParam);
        }
        ...
        if (khoiFilter != null && !khoiFilter.trim().isEmpty()) {
            try {
                ...
                idKhoi = null;
                System.out.println("Staff_ManageCourse: Invalid khoiFilter format - khoiFilter=" + khoiFilter);
            }
        }
        ...
        if (orderFilter != null && !orderFilter.trim().isEmpty()) {
            try {
                ...
                order = null;
                System.out.println("Staff_ManageCourse: Invalid orderFilter format - orderFilter=" + orderFilter);
            }
        }
        ...
        try {
            ...
            System.out.println("Staff_ManageCourse: Invalid date format - startDate=" + startDate + ", endDate=" + endDate);
        }
        ...
        try {
            if ("refresh".equalsIgnoreCase(action)) {
                ...
                try {
                    ...
                    request.getRequestDispatcher("/views/staff/staff_updateCourse.jsp").forward(request, response);
                    return;
                } catch (NumberFormatException e) {
            ...
            if (khoaHocList == null) {
                System.out.println("Staff_ManageCourse: Failed to retrieve course list from database");
                ...
                System.out.println("Staff_ManageCourse: No courses found for filters");
            ...
            System.out.println("Staff_ManageCourse: Error - " + e.getMessage());
            e.printStackTrace();
        ...
        if ("addKhoaHoc".equals(action)) {
            try {
                ...
                if (ten == null || ten.trim().isEmpty()) {
                    ...
                    request.getRequestDispatcher("/views/staff/staff_addCourse.jsp").forward(request, response);
                    return;
                }
                ten = ten.trim();
    ...
    public String getServletInfo() {
        return "Servlet to manage course listing, sorting, pagination, and actions for Staff";
    }
}