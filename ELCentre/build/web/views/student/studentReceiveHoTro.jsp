    ...
    <body>
        <div class="wrapper">
            ...
            <div class="header" style="
                ...
                z-index: 999;
            ">
                <h2 style="margin: 0; color: white;">Thông báo hỗ trợ</h2>
                <div class="user-menu">
        ...
        <div class="main-content">    
            <div style="display: flex; justify-content: space-between; align-items: center; margin: 0 30px 20px 30px;">
                <!-- Nút Gửi yêu cầu hỗ trợ -->
                <a href="${pageContext.request.contextPath}/views/student/studentGuiYeuCauHoTro.jsp" 
                   style="padding: 8px 16px; background-color: #007bff; color: white; border-radius: 5px; text-decoration: none; font-weight: bold;">
                    Gửi yêu cầu hỗ trợ
                </a>

                <!-- Form tìm kiếm -->
                <form method="get" action="${pageContext.request.contextPath}/SearchHoTroServlet" style="display: flex; gap: 8px;">
                    <input type="text" name="keyword" placeholder="Tìm kiếm hỗ trợ..." 
                           style="padding: 8px 12px; border-radius: 5px; border: 1px solid #ccc; font-size: 14px; width: 240px;">
                    <button type="submit" style="padding: 8px 14px; background-color: #1F4E79; color: white; border: none; border-radius: 5px; font-weight: bold;">
                        🔍 Tìm
                    </button>
                </form>
            </div>
