    ...
    <body>
        ...
        <form action="${pageContext.request.contextPath}/AddKhoaHoc" method="get">
            ...
            <select name="TenKhoaHoc" required>
                ...
                <!-- Các khóa cơ bản -->
                <option value="Khóa Toán">Khóa Toán</option>
                <option value="Khóa Ngữ văn">Khóa Ngữ văn</option>
                <option value="Khóa Vật lý">Khóa Vật lý</option>
                <option value="Khóa Hóa học">Khóa Hóa học</option>
                <option value="Khóa Sinh học">Khóa Sinh học</option>
                <option value="Khóa Tin học">Khóa Tin học</option>
                <option value="Khóa Lịch sử">Khóa Lịch sử</option>
                <option value="Khóa Địa lý">Khóa Địa lý</option>
                <option value="Khóa Giáo dục công dân">Khóa Giáo dục công dân</option>
                <option value="Khóa Tiếng Anh">Khóa Tiếng Anh</option>
                <option value="Khóa Công nghệ">Khóa Công nghệ</option>
