        ...
        <div id="layerslider_1_5r4q8o8aqo3t" class="ls-wp-container fitvidsignore" style="width:1000px;height:630px;margin:0 auto;margin-bottom: 0px;">
            <div class="ls-slide" data-ls="duration:9000;transition2d:1,4;timeshift:-1000;kenburnsscale:1.2;">
                <img 
                  ...
                  decoding="async" 
                  fetchpriority="high" 
                  srcset="https://dtguru.wpenginepowered.com/wp-content/uploads/2014/05/bg2.jpg 1920w, 
                        ...
                        <div class="fullwidth-bg">	
                            ...
                            <div  class='column dt-sc-one-fourth  '>
                                <div class="dt-sc-animate-num">
                                    ...
                                    <span class="dt-sc-num-count" data-value="75">3</span>
                                    <h3>Ngôn ngữ giảng dạy</h3>
                                </div>
                            </div>
                            <div  class='column dt-sc-one-fourth  '>
                                <div class="dt-sc-animate-num">
                                ...
                                <div class="dt-courses-wrapper">
                                    ...
                                    <div class="dt-courses-carousel">
                                       ...
                                       <div class="column dt-sc-one-third">
                                           ...
                                           <div class="column dt-sc-one-third">
                                               <!-- Course Starts -->
                                               <article id="post-2541" class="dt-sc-course post-2541 course type-course status-publish has-post-thumbnail hentry course-category-food post">
                                                   <div class="dt-sc-course-thumb">
                                                       <a href="https://dtguru.wpengine.com/course/fitness-sport-training-gym/" title="Fitness Sport Training Gym">
                                                           <img loading="lazy" decoding="async" width="420" height="250" src="${pageContext.request.contextPath}/dtguru.wpenginepowered.com/wp-content/uploads/2014/05/course7-420x250.jpg" class="attachment-course-list size-course-list wp-post-image" alt="" title="Fitness Sport Training Gym" />
                                                       </a>
                                                   </div>
                                                       <div class="dt-sc-course-content">
                                                           <p class="dt-sc-course-meta"> 
                                                               <a href="https://dtguru.wpengine.com/course-category/food/" rel="tag">Food</a> 
                                                           </p>
                                                           <h2 class="dt-sc-course-title">
                                                               <a href="https://dtguru.wpengine.com/course/fitness-sport-training-gym/" title="Fitness Sport Training Gym">Fitness Sport Training Gym</a>
                                                           </h2>
                                                           <a href="https://dtguru.wpengine.com/register/" class="dt-sc-course-price">Free</a>
                                                           <span class="dt-sc-lessons">3&nbsp;Lessons
                                                           </span>
                                                       </div>
                                               </article>
                                           </div><!-- Course Ends -->
