    ...
    <div class="wrapper">
        ...
        <div class="main-area">
            ...
            <div class="main-content">
                <form action="ParentEditProfileServlet" method="post" enctype="multipart/form-data" class="profile-form">
                    <div class="profile-grid">
                        <!-- Cột trái: Ảnh đại diện -->
                        <div class="profile-image-box">
                            <div class="avatar-box">
                                <c:choose>
                                    <c:when test="${not empty phuHuynh.avatar}">
                                        <img src="${pageContext.request.contextPath}/${phuHuynh.avatar}" alt="Avatar">
                                    </c:when>
                                    <c:otherwise>
                        ...
                        <!-- Cột phải: Thông tin phụ huynh -->
                        <div class="profile-info-box">
                            <div>
                                <label>Họ và tên</label>
                                <input type="text" name="hoTen" value="${phuHuynh.hoTen}" required>
                            </div>
                            <div>
                                <label>Email</label>
                            ...
                            <div>
                                ...
                                <input type="text" name="soDienThoai" value="${phuHuynh.SDT}">
                            </div>
                            <div>
                                <label>Địa chỉ</label>
                                <input type="text" name="diaChi" value="${phuHuynh.diaChi}">
                            </div>
                            <div>
                                <label>Ghi chú</label>
                                <textarea name="ghiChu" rows="3">${phuHuynh.ghiChu}</textarea>
                            </div>

                            <!-- Danh sách học sinh -->
                            <div style="grid-column: span 2;">
                                <label>Là phụ huynh của:</label>
                                <ul style="margin: 0; padding-left: 20px; color: #1F4E79;">
                                    <c:forEach var="child" items="${dsCon}">
                                        <li><strong>${child.hoTen}</strong> – Lớp: ${child.lopDangHocTrenTruong}</li>
                                    </c:forEach>
                                </ul>
                            </div>
