                        ...
                        <table id="payment-table">
                            ...
                            <tbody>
                                <c:forEach var="hocPhi" items="${dsHocPhi}" varStatus="loop">
                                    <tr>
                                        <td>${loop.count}</td>
                                        <td><c:out value="${hocPhi.hoTenHocSinh}" /></td> 
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <!-- Nút Xem -->
                                                <form action="${pageContext.request.contextPath}/StudentPaymentDetailServlet" method="get" style="display: inline-block;">
                                                ...
                                                <!-- Nút Xuất hóa đơn -->
                                                <form action="${pageContext.request.contextPath}/ExportPaymentServlet" method="post" style="display: inline-block;">
                                                    <input type="hidden" name="idHocPhi" value="${hocPhi.ID_HocPhi != null ? hocPhi.ID_HocPhi : ''}">
                                                ...
                                                <!-- ✅ Nút Gửi hỗ trợ -->
                                                <form action="${pageContext.request.contextPath}/ParentSupportServlet" method="post" style="display: inline-block;">
                                                    <input type="hidden" name="tenHoTro" value="Yêu cầu hỗ trợ học phí môn ${hocPhi.monHoc} - ${hocPhi.hoTenHocSinh}" />
                                                    <input type="hidden" name="moTa" value="Phụ huynh của học sinh ${hocPhi.hoTenHocSinh} cần hỗ trợ học phí lớp ${hocPhi.ID_LopHoc} môn ${hocPhi.monHoc}." />
                                                    <button class="action-btn" type="submit" title="Gửi hỗ trợ"><i class="fas fa-life-ring"></i> Hỗ trợ</button>
                                                </form>
                                            </div>
                                        </td>
