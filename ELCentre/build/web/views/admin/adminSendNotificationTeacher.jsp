<%-- 
    Document   : adminSendNotificationTeacher
    Created on : Jul 10, 2025, 10:03:54 AM
    Author     : wrx_Chur04
--%>
        ...
        <div class="main-content">
            ...
            <div class="notification-container">
                <div class="page-header">
                    <h2><i class="fas fa-bell"></i> Gửi thông báo đến giáo viên</h2>
                </div>

                <form action="${pageContext.request.contextPath}/adminActionWithTeacher" method="post" class="notification-form">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="noidung" name="noidung" placeholder="Soạn nội dung thông báo cho giáo viên..." required></textarea>
                    </div>
                ...
                <div class="back-button">
                    <a href="${pageContext.request.contextPath}/views/admin/adminReceiveGiaoVien.jsp" class="back-link"><i class="fas fa-arrow-left"></i> Quay lại danh sách giáo viên</a>
                </div>
            </div>
        </div>
