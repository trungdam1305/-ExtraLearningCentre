    ...
    <body>
        ...
        <div class="content-container">
            ...
            <div class="action-search-row">
                <a href="${pageContext.request.contextPath}/views/admin/addCourse.jsp" class="btn btn-custom-action">
                    <i class="bi bi-plus-circle"></i> Thêm khóa học mới
                </a>
                <a href="${pageContext.request.contextPath}/ManageCourse?action=refresh" class="btn btn-custom-action">
                                ...
                                <c:forEach var="course" items="${list}">
                                    <tr>
                                        ...
                                        <td class="action-buttons">
                                            ...
                                            <a href="${pageContext.request.contextPath}/ManageCourse?action=updateCourse&ID_KhoaHoc=${course.ID_KhoaHoc}" class="btn btn-danger btn-sm" aria-label="Cập nhật khóa học">
                                                <i class="bi bi-pencil"></i> Sửa
                                            </a>
                                            <c:choose>
                                                <c:when test="${course.ID_Khoi != null}">
                                                    <a href="${pageContext.request.contextPath}/ManageCourse?action=ViewCourse&ID_Khoi=${course.ID_Khoi}&ID_KhoaHoc=${course.ID_KhoaHoc}" class="btn btn-secondary btn-sm" aria-label="Xem danh sách lớp">
                ...
                <c:if test="${totalPages > 1}">
                    <div class="pagination-container">
                        <nav aria-label="Phân trang">
                            <ul class="pagination">
                                <li class="page-item">
                                    <a class="page-link" href="${pageContext.request.contextPath}/ManageCourse?action=paginate&page=1&statusFilter=${statusFilter}&name=${name}&khoiFilter=${khoiFilter}&orderFilter=${orderFilter}&startDate=${startDate}&endDate=${endDate}&sortColumn=${sortColumn}&sortOrder=${sortOrder}" aria-label="Trang đầu">
                                        <span aria-hidden="true">««</span>
                                    </a>
                                </li>
                                <c:if test="${pageNumber > 1}">
                                    <li class="page-item">
                                        <a class="page-link" href="${pageContext.request.contextPath}/ManageCourse?action=paginate&page=${pageNumber - 1}&statusFilter=${statusFilter}&name=${name}&khoiFilter=${khoiFilter}&orderFilter=${orderFilter}&startDate=${startDate}&endDate=${endDate}&sortColumn=${sortColumn}&sortOrder=${sortOrder}" aria-label="Trang trước">
                                            <span aria-hidden="true">«</span>
                                        </a>
                                    </li>
                                </c:if>
                                ...
                                <c:forEach var="i" begin="${startPage}" end="${endPage}">
                                    <li class="page-item ${i == pageNumber ? 'active' : ''}">
                                        <a class="page-link" href="${pageContext.request.contextPath}/ManageCourse?action=paginate&page=${i}&statusFilter=${statusFilter}&name=${name}&khoiFilter=${khoiFilter}&orderFilter=${orderFilter}&startDate=${startDate}&endDate=${endDate}&sortColumn=${sortColumn}&sortOrder=${sortOrder}">${i}</a>
                                    </li>
                                </c:forEach>
                                <c:if test="${pageNumber < totalPages}">
                                    <li class="page-item">
                                        <a class="page-link" href="${pageContext.request.contextPath}/ManageCourse?action=paginate&page=${pageNumber + 1}&statusFilter=${statusFilter}&name=${name}&khoiFilter=${khoiFilter}&orderFilter=${orderFilter}&startDate=${startDate}&endDate=${endDate}&sortColumn=${sortColumn}&sortOrder=${sortOrder}" aria-label="Trang sau">
                                            <span aria-hidden="true">»</span>
                                        </a>
                                    </li>
                                </c:if>
                                <li class="page-item">
                                    <a class="page-link" href="${pageContext.request.contextPath}/ManageCourse?action=paginate&page=${totalPages}&statusFilter=${statusFilter}&name=${name}&khoiFilter=${khoiFilter}&orderFilter=${orderFilter}&startDate=${startDate}&endDate=${endDate}&sortColumn=${sortColumn}&sortOrder=${sortOrder}" aria-label="Trang cuối">
                                        <span aria-hidden="true">»»</span>
                                    </a>
                                </li>
                            </ul>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="${pageContext.request.contextPath}/ManageCourse" method="post" id="deleteForm">
