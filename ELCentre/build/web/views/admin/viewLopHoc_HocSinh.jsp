                                ...
                                <c:forEach var="lopHoc" items="${lopHocs}">
                                    <tr>
                                        ...
                                        <td class="action-buttons">
                                            ...
                                            <c:url var="backUrl" value="/adminActionWithStudent">
                                                <c:param name="action" value="viewClass"/>
                                                <c:param name="id" value="${idHocSinh}"/>
                                            </c:url>
                                            <c:url var="backUrl" value="/adminActionWithStudent">
                                                <c:param name="action" value="viewClass"/>
                                                <c:param name="id" value="${idHocSinh}"/>
                                            ...
                                            <c:choose>
                                                <c:when test="${not empty idHocSinh and not empty lopHoc.idLopHoc and not empty lopHoc.idKhoaHoc and not empty lopHoc.idKhoi}">
                                                    <a href="${pageContext.request.contextPath}/ManageClassDetail_LopHoc_HocSinh?ID_LopHoc=${lopHoc.idLopHoc}&ID_KhoaHoc=${lopHoc.idKhoaHoc}&ID_Khoi=${lopHoc.idKhoi}&ClassCode=${fn:escapeXml(lopHoc.classCode)}&idHocSinh=${idHocSinh}" class="btn btn-secondary btn-sm" aria-label="Xem danh sách lớp">
                                                        <i class="bi bi-eye"></i> Danh sách lớp
                                                    </a>
                                                </c:when>
                                                <c:otherwise>
                                                    <span class="text-danger">Lỗi: Thiếu thông tin lớp học hoặc ID học sinh!</span>
                                                </c:otherwise>
                                            </c:choose>
