    ...
    <body>
        <div class="header">
            <div class="left-title">
                Quản lý học phí <i class="fas fa-money-check-alt"></i>
            </div>
        ...
        <div class="main-content">
            ...
            <div class="notification-container">
                <div class="page-header">
                    <h2><i class="fas fa-bell"></i> Soạn nội dung thông báo học phí</h2>
                </div>

                <form action="${pageContext.request.contextPath}/adminActionWithTuition" method="post" class="notification-form">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="contentPH" id="contentPH" placeholder="Soạn nội dung thông báo cho phụ huynh...">Kính gửi quý phụ huynh,
...
Trân trọng cảm ơn quý phụ huynh đã đồng hành cùng ELCENTRE!</textarea>
                    </div>

                    <!-- Nội dung gửi học sinh -->
                    <div class="form-group">
                        <label for="contentHS">Nội dung gửi học sinh:</label>
                        <textarea name="contentHS" id="contentHS" placeholder="Soạn nội dung thông báo cho học sinh...">Chào em ${TenHocSinh},
...
– ELCENTRE –</textarea>
                ...
                <div class="back-button">
                    <a href="${pageContext.request.contextPath}/adminGetFromDashboard?action=hocphi" class="back-link"><i class="fas fa-arrow-left"></i> Quay lại danh sách lớp</a>
                </div>
            </div>
        </div>
