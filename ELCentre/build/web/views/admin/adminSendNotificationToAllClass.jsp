<%-- 
    Document   : adminSendNotificationToAllClass
    Created on : Jul 11, 2025, 10:22:58 AM
    Author     : wrx_Chur04
--%>
...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title>Gửi thông báo đến tất cả lớp học</title>
        ...
        <div class="main-content">
            ...
            <div class="notification-container">
                <div class="page-header">
                    <h2><i class="fas fa-bell"></i> Gửi thông báo đến tất cả lớp học</h2>
                </div>

                <form action="${pageContext.request.contextPath}/adminActionWithNotification" method="post" class="notification-form">
                    <input type="hidden" name="type" value="sendToAllClass">

                    <div class="form-group">
                        <label for="noidungHS">Nội dung gửi học sinh:</label>
                        <textarea id="noidungHS" name="noidungHS" placeholder="Soạn nội dung thông báo cho học sinh..." required></textarea>
                    </div>

                    <div class="form-group">
                        <label for="noidungGV">Nội dung gửi giáo viên:</label>
                        <textarea id="noidungGV" name="noidungGV" placeholder="Soạn nội dung thông báo cho giáo viên..." required></textarea>
                    </div>
                ...
                <div class="back-button">
                    <a href="${pageContext.request.contextPath}/adminGetFromDashboard?action=thongbao" class="back-link"><i class="fas fa-arrow-left"></i> Quay lại danh sách thông báo</a>
                </div>
            </div>
        </div>
