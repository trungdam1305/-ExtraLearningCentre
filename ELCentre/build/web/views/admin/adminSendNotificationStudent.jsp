    ...
    String name = request.getParameter("name");
        ...
        <div class="notification-container">
            ...
            <form action="${pageContext.request.contextPath}/adminActionWithStudent" method="post">
                ...
                <textarea id="noidung" name="noidung" rows="5" required>
Chào em <%= name %> , đây là thông báo học phí từ EL CENTRE. Hiện tại trung tâm thấy em đang học tại lớp <%= tenlophoc %> và chưa đóng học phí với số tiền là <%= sotien %> . Đề nghị em đóng trong thời gian sớm nhất ! 
                </textarea>
