<%-- 
    Document   : viewClass_LopHoc_GiaoVien
    Created on : June 28, 2025, 9:33:02 PM
    Author     : Vuh26
--%>
                            ...
                            <div class="modal-body">
                                ...
                                <c:choose>
                                    <c:when test="${not empty availableTeachers}">
                                        ...
                                        <form id="assignTeacherForm" action="${pageContext.request.contextPath}/ManageClassDetail_LopHoc_GiaoVien" method="post">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <c:if test="${not empty allStudents}">
                                    ...
                                    <form id="addStudentForm" action="${pageContext.request.contextPath}/ManageClassDetail_LopHoc_GiaoVien" method="post">
