                ...
                <div class="data-table-container schedule-container">
                        ...
                        <div class="schedule-controls">
                            <div class="nav-buttons">
                                <a href="ParentViewScheduleServlet?viewDate=${previousWeekLink}" class="nav-button"><i class="fas fa-chevron-left"></i> Tuần trước</a>
                                <a href="ParentViewScheduleServlet" class="nav-button"><i class="fas fa-calendar-day"></i> Tuần này</a>
                                <a href="ParentViewScheduleServlet?viewDate=${nextWeekLink}" class="nav-button">Tuần sau <i class="fas fa-chevron-right"></i></a>
                            </div>
                            ...
                            <form action="ParentViewScheduleServlet" method="GET" class="week-picker-form">
