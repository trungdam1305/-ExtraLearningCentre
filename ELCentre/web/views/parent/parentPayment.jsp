        ...
        <div class="wrapper">
            ...
            <div class="main-area">
                ...
                <div class="header">
                    <div class="header">
                        <h2>
                            ...
                            Thông tin học phí theo con cái
                        </h2>
                    ...
                    <div class="user-menu">
                        <div class="user-toggle" onclick="toggleUserMenu()">
                            <span><strong>${fn:escapeXml(phuHuynh.hoTen)}</strong>
                                <img src="${pageContext.request.contextPath}/${fn:escapeXml(phuHuynh.avatar)}" class="user-avatar" alt="Avatar">
                                ☰
                            </span>
                        </div>
                ...
                <div class="main-content">
                    <h1 class="page-title">Thông Tin Học Phí Theo Con Cái</h1>
                    <h3>Danh sách con</h3>
                    <c:choose>
                            ...
                            <c:forEach var="child" items="${dsCon}">
                                <div class="child-card">
                                    <div class="child-info">
                                        <img src="${pageContext.request.contextPath}/${fn:escapeXml(child.avatar)}" alt="avatar" class="child-avatar">
                                        <div class="child-details">
                                            <strong>${fn:escapeXml(child.hoTen)}</strong><br>
                                            Lớp: ${fn:escapeXml(child.lopDangHocTrenTruong)}<br>
                                            Ngày sinh: ${fn:escapeXml(child.ngaySinh)}
                                        </div>
                                    </div>
