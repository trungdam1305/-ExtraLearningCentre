...
<div class="notification-container">
    <h2>Gửi thông báo đến giáo viên</h2>
    ...
    <a href="${pageContext.request.contextPath}/views/admin/adminReceiveGiaoVien.jsp" class="back-link">← Quay lại danh sách giáo viên</a>
</div>
