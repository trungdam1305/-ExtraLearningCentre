...
<html>
    ...
    <body>
        ...
        <div class="main-content">
            ...
            %>
            <form method="post" action="adminActionWithStudent">
                        ...
                        <div class="table-container">
                            <table>
                                <thead>
                                    <tr>
                                        <th>ID Tài Khoản</th>
                                            ...
                                            <th><input type="text" name="idtaikhoan" value="${hocsinh.getID_TaiKhoan()}" readonly /></th>
                                            </c:forEach>
                                    </tr>
                                    <tr>
                                        <th>Thông tin</th>
                                            ...
                                            <select name="idTruongHoc">
                                                <c:forEach var="truong" items="${truonghoc}">
                                                    <option value="${truong.getID_TruongHoc()}"
                                                            <c:if test="${truong.getTenTruongHoc() == hocsinh.getTenTruongHoc()}">selected</c:if>>
                                ...
                                <tr>
                                    ...
                                    <c:forEach var="hocsinh" items="${hocsinhs}">
                                        <td><input type="text" name="lop" value="${hocsinh.getLopDangHocTrenTruong()}" required="" /></td>
                                        </c:forEach>
                                </tr>
                                <tr>
                                    <td>Trạng thái học tại EL CENTRE</td>
                                    <c:forEach var="hocsinh" items="${hocsinhs}">
                                        <td><input type="text" name="trangthaihoc" value="${hocsinh.getTrangThaiHoc()}" readonly /></td>
                                        </c:forEach>
                                </tr>
                                <tr>
                                    <td>Số điện thoại</td>
                                    ...
                                    <c:forEach var="hocsinh" items="${hocsinhs}">
                                        <td><input type="text" name="sdt" value="${hocsinh.getSoDienThoai()}" required="" /></td>
                                        </c:forEach>
                                </tr>
