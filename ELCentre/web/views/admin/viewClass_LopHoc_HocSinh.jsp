        ...
        <style>
            * {
            ...
            .teacher-select .form-control, .student-select .form-control {
                ...
                height: 28px;
                font-size: 0.57rem;
                width: 200px; /* Thu nhỏ độ dài ô tìm kiếm */
            }
            ...
            .modal-dialog {
                max-width: 1000px; /* Tăng kích thước modal */
            }
            ...
            <c:if test="${lopHoc != null}">
                ...
                <c:choose>
                    <c:when test="${giaoVien != null}">
                        ...
                        <form action="${pageContext.request.contextPath}/ManageClassDetail_LopHoc_HocSinh" method="post" style="display:inline;">
                            ...
                            <div class="modal-body">
                                ...
                                <c:choose>
                                    <c:when test="${not empty availableTeachers}">
                                        ...
                                        <form id="assignTeacherForm" action="${pageContext.request.contextPath}/ManageClassDetail_LopHoc_HocSinh" method="post">
                ...
                <c:choose>
                    <c:when test="${not empty hocSinhList}">
                        <form id="removeStudentsForm" action="${pageContext.request.contextPath}/ManageClassDetail_LopHoc_HocSinh" method="post">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <c:if test="${not empty allStudents}">
                                    ...
                                    <form id="addStudentForm" action="${pageContext.request.contextPath}/ManageClassDetail_LopHoc_HocSinh" method="post">
                                                ...
                                                <tbody>
                                                    <c:forEach var="student" items="${allStudents}">
                                                        <tr>
                                                            ...
                                                            <td>${student.lopDangHocTrenTruong != null ? student.lopDangHocTrenTruong : 'Chưa có'}</td>
                                                            <td>${student.tenTruongHoc != null ? student.tenTruongHoc : 'Chưa có'}</td>
                                                            <td><input type="checkbox" name="selectedStudents" value="${student.ID_HocSinh}"></td> <!-- Checkbox -->
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
                                            </table>
