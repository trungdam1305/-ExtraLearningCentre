<%-- 
    ...
    - @Param giaoviens (ArrayList<HocSinh_ChiTietHoc>): A request attribute containing the list of class of student objects fetched from the database.
--%>
                        ...
                        <tbody id="teacherTableBody">
                            <c:forEach var="sct" items="${hocsinhchitiets}">
                                <tr>
                                    ...
                                    <td>${sct.getHoTen()}</td>
                                    <td>
                                        <a class="action-link" href="${pageContext.request.contextPath}/adminActionWith?action=view&id=${giaovien.getID_LopHoc()}">Gửi thông báo</a> 
                                    </td>
                                </tr>   
                            </c:forEach>
                        </tbody>
