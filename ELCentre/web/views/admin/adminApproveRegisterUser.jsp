...
<body>
    ...
    <c:choose>
        <c:when test="${not empty requestScope.listThongBao}">
            <table>
                <thead>
                    <tr>
                        <th>ID</th>
                ...
                <tbody>
                    <c:forEach var="tb" items="${requestScope.listThongBao}">
                        <tr>
                            <td>${tb.ID_ThongBao}</td>
                            <td>${tb.noiDung}</td>
                            <td>${tb.thoiGian}</td>
                            <td>
                                <form action="sendAdviceMail.jsp" method="get">
    ...
    <div class="back-button">
        <a href="adminDashboard.jsp">Quay lại trang chủ</a>
    </div>
</body>
</html>
