<%-- 
    Document   : adminUpdateStaffInfor
    Created on : Jul 24, 2025, 12:07:15 AM
    Author     : wrx_Chur04
--%>
                        ...
                        <div class="table-container">
                            <table>
                                <thead>
                                    <tr>
                                        <th>Thông tin</th>
                                        <c:forEach var="ph" items="${staffs}">
                                            <th><input type="text" name="idstaff" value="${ph.getID_Staff()}" readonly /></th>
                                        </c:forEach>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        <td>SĐT</td>
                                        <c:forEach var="ph" items="${staffs}">
                                            <td><input type="number" name="sdt" value="${ph.getSoDienThoai()}" required="" /></td>
                                        </c:forEach>
                                    </tr>
                                    <tr>
                                        <td>Email</td>
