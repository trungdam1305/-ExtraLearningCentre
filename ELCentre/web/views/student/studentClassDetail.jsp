...
<div class="main-content">
    ...
    <div class="info-box">
        ...
        <div class="info-grid">
            ...
            <div class="info-item"><span class="label">Họ tên:</span> ${giaoVien.hoTen}</div>
            <div class="info-item"><span class="label">Email:</span> ${giaoVien.email}</div>
            <div class="info-item"><span class="label">SĐT:</span> ${giaoVien.SDT}</div>
            <div class="info-item" style="flex: 1 1 100%;"><span class="label">Chuyên môn:</span> ${giaoVien.chuyenMon}</div>
        </div>
    </div>
</div>
