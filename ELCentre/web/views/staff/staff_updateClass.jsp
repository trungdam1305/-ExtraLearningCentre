...
<%@ page import="model.LopHocInfoDTO, java.util.UUID, java.util.List, java.util.ArrayList, dal.LichHocDAO, model.LichHoc, model.Staff, dal.StaffDAO, model.TaiKhoan"%>
        ...
        <div class="form-container">
            ...
            <c:if test="${not empty suc}">
                ...
                <div class="dashboard-button">
                    <form action="${pageContext.request.contextPath}/Staff_ManageClass" method="get">
            ...
            <c:if test="${not empty lopHoc && not empty slotHocList && not empty phongHocList}">
                <form action="${pageContext.request.contextPath}/Staff_ManageClass" method="post" id="updateClassForm" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <button type="button" class="btn btn-custom-action mt-2" onclick="addScheduleRow()"><i class="bi bi-plus-circle"></i> Thêm lịch học</button>
                    </div>
