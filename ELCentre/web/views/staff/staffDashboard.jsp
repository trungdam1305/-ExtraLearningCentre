...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li><a href="${pageContext.request.contextPath}/staffViewSalary"><i class="fas fa-money-check-alt"></i> Lương</a></li>
        </ul>
                        ...
                        <table>
                            ...
                            <tbody id="consultationTableBody">
                                <c:forEach var="consult" items="${ConsultationList}">
                                    <tr>
                                        <td>${consult.getHoTen()}</td>
                                        <td>${consult.getEmail()}</td>
                                        <td>${consult.getSoDienThoai()}</td>
                                        <td>${consult.getThoiGian()}</td>
                                        <td>
                                            <a class="btn-action update" href="${pageContext.request.contextPath}/staffActionWithConsultation?action=approve&id=${consult.getID_TuVan()}">
