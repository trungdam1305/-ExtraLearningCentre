...
<body>
    ...
    <div class="content-container">
        ...
        <c:if test="${danhSachLopHoc == null && not empty ID_KhoaHoc && not empty ID_Khoi}">
            <div class="alert alert-custom-danger" role="alert">Danh sách lớp học chưa được khởi tạo. Kiểm tra servlet Staff_ManageClass hoặc dữ liệu cơ sở dữ liệu.</div>
        </c:if>
        ...
        <c:if test="${empty teacherList}">
            <div class="alert alert-custom-danger" role="alert">Không có giáo viên nào trong danh sách teacherList. Kiểm tra servlet Staff_ManageClass hoặc GiaoVienDAO.</div>
        </c:if>

        <!-- Nút hành động và form tìm kiếm/lọc -->
        <div class="action-search-row">
            <c:if test="${not empty ID_KhoaHoc && not empty ID_Khoi}">
                <a href="${pageContext.request.contextPath}/Staff_ManageClass?action=showAddClass&ID_KhoaHoc=${ID_KhoaHoc}&ID_Khoi=${ID_Khoi}" class="btn btn-custom-action">
                    <i class="bi bi-plus-circle"></i> Thêm lớp học mới
                </a>
                <a href="${pageContext.request.contextPath}/Staff_ManageClass?action=refresh&ID_Khoi=${ID_Khoi}&ID_KhoaHoc=${ID_KhoaHoc}" class="btn btn-custom-action">
                    <i class="bi bi-arrow-clockwise"></i> Làm mới
                </a>
                <form action="${pageContext.request.contextPath}/Staff_ManageClass" method="get" id="filterForm" style="display: flex; align-items: center; gap: 6px; flex-wrap: nowrap;">
                            ...
                            <c:forEach var="lopHoc" items="${danhSachLopHoc}">
                                <tr>
                                    ...
                                    <td class="action-buttons">
                                        ...
                                        <a href="${pageContext.request.contextPath}/Staff_ManageClass?action=updateClass&ID_LopHoc=${lopHoc.idLopHoc}&ID_KhoaHoc=${ID_KhoaHoc}&ID_Khoi=${ID_Khoi}" class="btn btn-danger btn-sm" aria-label="Cập nhật lớp học">
                                            <i class="bi bi-pencil"></i> Sửa
                                        </a>
                                        <a href="${pageContext.request.contextPath}/Staff_ManageClassDetail?ID_LopHoc=${lopHoc.idLopHoc}&ID_KhoaHoc=${ID_KhoaHoc}&ID_Khoi=${ID_Khoi}&ClassCode=${lopHoc.classCode}" class="btn btn-secondary btn-sm" aria-label="Xem danh sách lớp">
                        ...
                        <ul class="pagination">
                            ...
                            <c:forEach var="i" begin="${startPage}" end="${endPage}">
                                <li class="page-item ${i == page ? 'active' : ''}">
                                    <a class="page-link" href="${pageContext.request.contextPath}/Staff_ManageClass?action=paginate&page=${i}&sortName=${sortName}&searchQuery=${searchQuery}&teacherFilter=${teacherFilter}&feeFilter=${feeFilter}&orderFilter=${orderFilter}&sortColumn=${sortColumn}&sortOrder=${sortOrder}&ID_KhoaHoc=${ID_KhoaHoc}&ID_Khoi=${ID_Khoi}">${i}</a>
                                </li>
                            </c:forEach>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="${pageContext.request.contextPath}/Staff_ManageClass" method="post" id="deleteForm">
        ...
        <div class="dashboard-button">
            <form action="${pageContext.request.contextPath}/Staff_ManageCourse">
