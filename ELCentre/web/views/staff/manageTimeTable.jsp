                ...
                <div class="card-body">
                            ...
                            <c:forEach var="lop" items="${activeClassList}">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="StaffManageTimeTable?action=viewDetail&classId=${lop.ID_LopHoc}" class="btn btn-sm" style="background: linear-gradient(135deg, #E0F7FA, #B2EBF2)">
                                            <i class="fas fa-calendar-week"></i> Xem TKB
                                        </a>
                                    </td>
                                </tr>
                            </c:forEach>
                    ...
                    <nav class="mt-4">
                        <ul class="pagination justify-content-center">
                            <c:url var="paginationUrl" value="StaffManageTimeTable">
